...
int main() {
    ...
    // podamo ime datoteke
    std::string filename = "G:\\Moj disk\\faks\\3. letnik 1. semester\\Napredna računalniška orodja\\C++\\DN 5 dodatno\\DN 5\\datoteka_A_b.txt";
...
#pragma omp critical
    ...
    std::cout << "Time of Gauss-Seidel - OpenMP : " << time_duration_omp.count() << " seconds" << std::endl;
